package IntroductionJava.BàiTap.Bai16.Optional_File_csv;

import java.io.*;
import java.util.Scanner;

public class cFile {
    static final String PATH = "src\\IntroductionJava\\BàiTap\\Bai16\\Optional_File_csv\\docfilecsv";
    ...
    public static void showCountry(){
        String csvFile = "src\\IntroductionJava\\BàiTap\\Bai16\\Optional_File_csv\\docfilecsv\\country.csv";
